...
class PDE:
    ...
    Example:
        ...
        >>> pde = ppsci.pde.PDE(indvar=[x, y], dvar=[u])
    ...
    def set_ic(self, *args):
        ...
        Example:
            >>> pde = ppsci.pde.NavierStokes(dim=3, time_dependent=True)
            >>> ic1 = ppsci.ic.IC('u', rhs=0)
            >>> ic2 = ppsci.ic.IC('v', rhs=0)
    ...
    def set_time_interval(self, interval):
        ...
        Example:
            >>> import paddlescience as psci
            >>> pde = ppsci.pde.NavierStokes(dim=2, time_dependent=True)
