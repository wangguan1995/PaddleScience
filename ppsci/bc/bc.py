...
class Dirichlet(BC):
    ...
    Example
        ...
        >>> bc1 = ppsci.bc.Dirichlet("u", rhs=0.0)
        >>> bc2 = ppsci.bc.Dirichlet("u", rhs=lambda x, y: cos(x)*cosh(y))
    """
...
class Neumann(BC):
    ...
    Example
        >>> import paddlescience as psci
        >>> bc1 = ppsci.bc.Neumann("u", rhs=1.0)
        >>> bc2 = ppsci.bc.Neumann("u", rhs=lambda x, y: 1.0)
    """
...
class Robin(BC):
    ...
    Example:
        >>> import paddlescience as psci
        >>> bc1 = ppsci.bc.Robin("u", rhs=0.0)
        >>> bc2 = ppsci.bc.Robin("u", rhs=lambda x, y: 0.0)
    """
