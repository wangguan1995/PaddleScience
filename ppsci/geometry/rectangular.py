...
class Rectangular(Geometry):
    ...
    Example:
        ...
        >>> geo3d = ppsci.geometry.Rectangular(origin=(0.0,0.0,0.0), extent=(2.0,2.0,2.0))
    """
...
class CircleInRectangular(Rectangular):
    ...
    Example:
        >>> import paddlescience as psci
        >>> geo2d = ppsci.geometry.CircleInRectangular(origin=(0.0,0.0), extent=(1.0,1.0), circle_center=(0.5,0.5), circle_radius=0.1)
   """
